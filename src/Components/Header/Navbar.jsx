...
const NavBar = () => {
  return (
    <div className="navbar bg-white shadow-sm lg:max-w-7xl lg:mx-auto font-display">
      ...
      <div className="navbar-end ">
        <a className="btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] lg:w-[145px] lg:h-[43px] border-none ">
          <img src={btnIcon} alt="" />
